...
db.query("CREATE TABLE IF NOT EXISTS db_rap.users (`id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT, `username` VARCHAR(32) NOT NULL, `email` VARCHAR(128) NOT NULL, `password` VARCHAR(128) NOT NULL, `admin` ENUM('0', '1', '2') NOT NULL);");
